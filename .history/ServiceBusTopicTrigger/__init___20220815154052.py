...
# 存储账户连接字符串
file_connection_string = 'DefaultEndpointsProtocol=https;AccountName=adasdemostorage;AccountKey=7x5iWZKa2A1AkUmTD9s3jyIqBZefxB6yIAZ52t3Q+1BmFdsjG82VTuM9PGV49pU4SUpgvzmv26w0+ASt2Mf7yQ==;EndpointSuffix=core.windows.net'
# 服务总线连接字符串
service_bus_connection_string = 'Endpoint=sb://adas-demo.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=dqSN6+Qaz1GsExDqsLYNyT97eiByvam8ZFGH0eNjc/I='
